...
function Comprados({ products, setProducts, precioComprados }) {
  console.log(precioComprados);
  ...
  const handleAdd = () => {
    ...
    setFormData({ NombreProducto: "", Precio: "", categ: "", link: "", comprado: true });
    setIsOpen(false);
  };
  ...
  return (
    <div className="block">
      ...
      <p>Total gastado: ${precioComprados}</p>
      ...
      {isOpen && (
        <div className="overlay">
          <div className="floating-window">
            <h2>Agregar Producto Comprado</h2>
